...
<body class="light">
        ...
        <div id="main" class="layout-horizontal">
            <header class="mb-5">
                <div class="header-top">
                    <div class="container">
                        <div class="logo">
                            <a href="{{ route('lobby') }}"><img src="{{ asset('img/rbtgtech.png') }}"
                                    alt="Logo"></a>
                        </div>
    ...
    {{-- <script src="https://dashboard.berkahbahagia.site/mazer/assets/extensions/jquery/jquery.min.js"></script>
    <script src="https://dashboard.berkahbahagia.site/mazer/assets/extensions/datatables.net/js/jquery.dataTables.min.js">
    </script>
    <script
        src="https://dashboard.berkahbahagia.site/mazer/assets/extensions/datatables.net-bs5/js/dataTables.bootstrap5.min.js">
    </script>
    <script src="https://dashboard.berkahbahagia.site/mazer/assets/static/js/pages/datatables.js"></script> --}}
