<script>
    ...
    function getTabelBahanKitchen() {
        $('#dt_bahan_kitchen').DataTable({
            scrollCollapse: true,
            paging: true,
            processing: true,
            retrieve: true,
            destroy: true,
            ajax: {
                url: "{{ route('getTabelBahanKitchen', ['cabang' => '__cabang__']) }}".replace(
                    '__cabang__', cabang),
            },
            columns: [{
                    data: 'id',
    ...
    function getRiwayatBahan_kitchen(bhnid) {
        ...
        $('#dt_riwayatBahan').DataTable({
            ...
            // autoWidth: true,
            ajax: {
                url: "{{ route('getRiwayatBahan_kitchen_persediaan', ['cabang' => '__cabang__']) }}".replace(
                    '__cabang__', cabang),
                data: function(d) {
                    d.bhnid = bhnid;
                }
