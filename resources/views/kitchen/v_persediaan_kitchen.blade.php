                            ...
                            <div class="card-body">
                                <form class="form" id="formTransaksi">
                                    ...
                                    <div class="row">
                                        ...
                                        <h4>Persediaan bahan di gudang kitchen: <span id="titleDetail"
                                                ...
                                                <div class="card-header">
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <table class="table table-hover mb-0 " id="dt_bahan_kitchen"
                                                                style="width:100%">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Kode</th>
                                ...
                                <div class="row">
                                    ...
                                    <h4>Persediaan bahan olah di cabang ini: <span id="titleDetail"
                                            class="badge bg-primary"></span>
                                    </h4>
                                    <hr>
                                    <div class="row">
...
@push('js')
    @include('kitchen.persediaan_kitchen-js')
@endpush
