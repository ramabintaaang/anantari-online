...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Pembelian & Order</li>
                            ...
                            <div class="card-body">
                                ...
                                <form class="form" id="formInputPembelian">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <h6>Tanggal Order barang<span class="text-danger "
...
@push('js')
    @include('transaksi.bar.pembelian_bar-js')
@endpush
