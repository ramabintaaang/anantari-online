...
class BahanExportKitchen implements FromCollection, WithHeadings,WithStyles,ShouldAutoSize,WithCustomStartCell,WithEvents
{
    protected $bahan;
    protected $startDate;
    protected $endDate;
...
$saldoAwal = DB::table('stock_barang as a')
    ->join('bahan_kitchen as b', 'b.bhnid', '=', 'a.sbbahan')
    ->select(
        'a.sbid',
        'b.bhnnama',
...
$transaksiMutasi = DB::table('stock_barang as a')
    ...
    // Tempatkan orderBy sebelum get()
    ->orderBy('bhnnama')
    ->orderBy('tgl');  // Menambahkan urutan berdasarkan 'tgl' setelah 'bhnnama'
