...
$query1 = DB::table('pembeliand as a')
    ...
    ->leftJoin('bahan_bar as b', 'a.pmbdbrg', '=', 'b.bhnid')
...
$query1->unionAll(
    DB::table('transaksid as a')
        ...
        ->leftJoin('bahan_bar as c', 'b.tnsbbahan', '=', 'c.bhnid')
...
$query1->unionAll(
    DB::table('stock_opname as a')
        ->select([
            ...
            DB::raw("CONCAT('Stock Opname Bahan Olah - ', a.sopnama) as keterangan"),
            'c.bhonama as bahan',
...
$query1->unionAll(
    DB::table('stock_opname as a')
        ...
        ->leftJoin('stock_opnamed as b', 'b.sopdparent', '=', 'a.sopid')
        ->leftJoin('bahan_bar as c', 'b.sopdbahan', '=', 'c.bhnid')
